...
cadence. It deliberately does not create entry signals or modify structural institutional liquidity geometry;
...
class PortfolioManager:
    ...
    def allocate_balance(self, ctx: Optional[Any], contexts: List[Any], raw_balance: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        if mode in {'equal_slots', 'active_equal_slots', 'active_slots'}:
            # Compatibility test mode: split cash into fixed slots.
