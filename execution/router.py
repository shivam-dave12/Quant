...
class ExecutionRouter:
    ...
    @property
    def api(self):
        """Compatibility: strategy accesses order_manager.api directly."""
    ...
    def place_reconciled_reduce_only_exit(self, *a, **kw): return self.active.place_reconciled_reduce_only_exit(*a, **kw)
