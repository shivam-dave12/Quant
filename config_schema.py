"""
config_schema.py — Pydantic v2 schema for active institutional liquidity risk controls.
==========================================================================
...
class SLConfig(BaseModel):
    ...
    Institutional_STOP_CLEARANCE_BASE_ATR: float = Field(
        default_factory=lambda: _c("Institutional_STOP_CLEARANCE_BASE_ATR", 0.10),
        ge=0.0,
        le=2.0,
        description="Extra wick-depth clearance beyond swept structure.",
    )
    Institutional_STOP_CLEARANCE_PCTL_SLOPE_ATR: float = Field(
        default_factory=lambda: _c("Institutional_STOP_CLEARANCE_PCTL_SLOPE_ATR", 0.18),
        ge=0.0,
        le=3.0,
...
class TradingConfig(BaseModel):
    """Validated configuration for the sole institutional liquidity entry authority."""
