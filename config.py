...
HYPERLIQUID_SECONDARY_WS_ENABLED = os.getenv("HYPERLIQUID_SECONDARY_WS_ENABLED", "true").lower() == "true"
HYPERLIQUID_MAX_WS_CONNECTIONS = int(os.getenv("HYPERLIQUID_MAX_WS_CONNECTIONS", "6"))
