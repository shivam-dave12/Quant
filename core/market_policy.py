...
def build_instrument_policy(inst: Optional[TradableInstrument]) -> InstrumentPolicy:
    ...
    base_margin = _f('INSTITUTIONAL_MARGIN_PCT', 0.20)
    ...
    if ac == AssetClass.OPTION:
        return InstrumentPolicy(
            ...
            spread_soft_atr_ratio=_f('INSTITUTIONAL_SPREAD_SOFT_ATR_RATIO_OPTION', 0.65),
            spread_max_atr_ratio=_f('INSTITUTIONAL_MAX_SPREAD_ATR_RATIO_OPTION', 3.00),
            spread_max_bps=_f('INSTITUTIONAL_MAX_SPREAD_BPS_OPTION', 180.0),
            spread_max_ticks=_f('INSTITUTIONAL_MAX_SPREAD_TICKS_OPTION', 20.0),
            spread_min_size_mult=_f('INSTITUTIONAL_SPREAD_MIN_SIZE_MULT', 0.35),
            spread_haircut_max=_f('INSTITUTIONAL_SPREAD_SIZE_HAIRCUT_MAX', 0.65),
    ...
    if ac == AssetClass.EQUITY:
        return InstrumentPolicy(
            ...
            spread_soft_atr_ratio=_f('INSTITUTIONAL_SPREAD_SOFT_ATR_RATIO_EQUITY', 0.50),
            spread_max_atr_ratio=_f('INSTITUTIONAL_MAX_SPREAD_ATR_RATIO_EQUITY', 4.00),
            spread_max_bps=_f('INSTITUTIONAL_MAX_SPREAD_BPS_EQUITY', 35.0),
            spread_max_ticks=_f('INSTITUTIONAL_MAX_SPREAD_TICKS_EQUITY', 8.0),
            spread_min_size_mult=_f('INSTITUTIONAL_SPREAD_MIN_SIZE_MULT', 0.35),
            spread_haircut_max=_f('INSTITUTIONAL_SPREAD_SIZE_HAIRCUT_MAX', 0.55),
    ...
    if ac == AssetClass.COMMODITY:
        return InstrumentPolicy(
            ...
            spread_soft_atr_ratio=_f('INSTITUTIONAL_SPREAD_SOFT_ATR_RATIO_COMMODITY', 0.50),
            spread_max_atr_ratio=_f('INSTITUTIONAL_MAX_SPREAD_ATR_RATIO_COMMODITY', 2.00),
            spread_max_bps=_f('INSTITUTIONAL_MAX_SPREAD_BPS_COMMODITY', 45.0),
            spread_max_ticks=_f('INSTITUTIONAL_MAX_SPREAD_TICKS_COMMODITY', 10.0),
            spread_min_size_mult=_f('INSTITUTIONAL_SPREAD_MIN_SIZE_MULT', 0.35),
            spread_haircut_max=_f('INSTITUTIONAL_SPREAD_SIZE_HAIRCUT_MAX', 0.55),
    ...
    return InstrumentPolicy(
        ...
        atr_min_pctile=_f('INSTITUTIONAL_ATR_MIN_PCTILE', 0.05),
        atr_max_pctile=_f('INSTITUTIONAL_ATR_MAX_PCTILE', 0.97),
        max_hold_sec=_desk_int(desk, "max_hold_sec", _i('INSTITUTIONAL_MAX_HOLD_SEC', 3600)),
        cooldown_sec=_desk_int(desk, "cooldown_sec", base_cooldown),
        loss_lockout_sec=_i('INSTITUTIONAL_LOSS_LOCKOUT_SEC', 1800),
        min_rr=_desk_float(desk, "min_rr", base_rr),
        max_rr=_desk_float(desk, "max_rr", _f('INSTITUTIONAL_TP_MAX_RR', 3.5)),
        sl_buffer_atr_mult=_desk_float(desk, "sl_buffer_atr", _f('INSTITUTIONAL_SL_BUFFER_ATR_MULT', 0.4)),
        slippage_tolerance=_f('INSTITUTIONAL_SLIPPAGE_TOLERANCE', 0.0005),
        spread_soft_atr_ratio=_f('INSTITUTIONAL_SPREAD_SOFT_ATR_RATIO_CRYPTO', 0.30),
        spread_max_atr_ratio=_f('INSTITUTIONAL_MAX_SPREAD_ATR_RATIO', 0.50),
        spread_max_bps=_f('INSTITUTIONAL_MAX_SPREAD_BPS_CRYPTO', 12.0),
        spread_max_ticks=_f('INSTITUTIONAL_MAX_SPREAD_TICKS_CRYPTO', 10.0),
        spread_min_size_mult=_f('INSTITUTIONAL_SPREAD_MIN_SIZE_MULT', 0.35),
        spread_haircut_max=_f('INSTITUTIONAL_SPREAD_SIZE_HAIRCUT_MAX', 0.55),
        notes='crypto policy',
        **desk_fields,
