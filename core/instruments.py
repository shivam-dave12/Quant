    ...
    * xStock products are tokenized/RWA derivatives, not direct shares. They
    ...
    return [
        ...
        AssetIntent("GOLD_HL", "Hyperliquid GOLD HIP-3", AssetClass.COMMODITY,
                    ("xyz:GOLD",), priority=12),
        AssetIntent("SILVER_SLVON", "SLV Ondo token derivative", AssetClass.COMMODITY,
                    ("SLVONUSD", "SLVON"), priority=13),
        AssetIntent("SILVER_XAG", "CoinSwitch XAG perpetual", AssetClass.COMMODITY,
                    ("XAGUSDT", "XAG/USDT", "XAG"), priority=14),
        AssetIntent("SILVER_HL", "Hyperliquid SILVER HIP-3", AssetClass.COMMODITY,
                    ("xyz:SILVER",), priority=15),
