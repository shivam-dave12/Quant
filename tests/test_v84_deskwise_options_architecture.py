...
def test_desk_router_separates_btc_crypto_us_stocks_commodities_and_options():
    ...
    opt = _inst("NIFTY_25000_C", ExchangeName.ICICI, AssetClass.OPTION, "NIFTY28MAY2625000CE", {"stock_code": "NIFTY", "right": "call", "strike_price": "25000", "expiry_date": "28-May-2026"})
