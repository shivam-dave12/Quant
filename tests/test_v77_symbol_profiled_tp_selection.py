...
@pytest.mark.parametrize(
    ...
    [
        ("GOLD", AssetClass.COMMODITY, "commodity_structural_full_tp"),
        ("SILVER", AssetClass.COMMODITY, "commodity_structural_full_tp"),
        ("NVDA", AssetClass.EQUITY, "high_beta_xstock_spread_aware"),
        ("TSLA", AssetClass.EQUITY, "high_beta_xstock_spread_aware"),
        ("COIN", AssetClass.EQUITY, "high_beta_xstock_spread_aware"),
        ("CRCL", AssetClass.EQUITY, "high_beta_xstock_spread_aware"),
        ("AAPL", AssetClass.EQUITY, "large_cap_xstock_clean_tp"),
        ("AMZN", AssetClass.EQUITY, "large_cap_xstock_clean_tp"),
        ("META", AssetClass.EQUITY, "large_cap_xstock_clean_tp"),
        ("GOOGL", AssetClass.EQUITY, "large_cap_xstock_clean_tp"),
        ("SPY", AssetClass.EQUITY, "large_cap_xstock_clean_tp"),
        ("QQQ", AssetClass.EQUITY, "large_cap_xstock_clean_tp"),
    ],
)
