    ...
    def record_trade(
        ...
        with self._lock:
            ...
            try:
                ...
                base_unit = str(getattr(getattr(instrument, "primary", None), "base_asset", "") or "").upper()
                qty_unit = base_unit if base_unit and "crypto" in asset_class else ("contracts" if asset_class else "units")
            except Exception:
