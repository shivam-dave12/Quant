...
class QuantStrategy:
    ...
    def _institutional_decision_matrix(self, signal, ict_ctx, flow_state,
        ...
        if is_sweep:
            try:
                ...
                # Cache the exact readiness decision on the signal. The final
                # unified route check must reuse this result instead of running
                # the same readiness filter a second time on the same candidate.
                setattr(signal, "_entry_readiness_decision", entry_readiness)
    ...
    def _unified_entry_gate(self, signal, ict_ctx, flow_state,
        ...
        """
        readiness = getattr(signal, "_entry_readiness_decision", None)
    ...
    def _compute_quantity(self, risk_manager, price,
        ...
        if portfolio_scoped and "portfolio_remaining_risk_cap" in bal:
            try:
